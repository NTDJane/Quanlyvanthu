                ...
                <table >
                    <thead >
                        <tr>
                            ...
                            <th>Content</th>
                            <th>Date issued</th>
                           <th style="width: 60px;text-align: center">Execute dispatch</th>
                        </tr>
                    </thead>
                    <tbody>
                        <%
                        ...
                        <tr style="height: 70px">
                            ...
                            <td style="width: 60px;text-align: center"><a href="Xacnhanxuly?idcongvan=<%=congvan.getSothutu()%>"><img src="images/refresh-icon.png"></a></td>
                        </tr>
                        <%}%>
                    </tbody>
                </table>
                <div>
                    ...
                    <ul class="pagination">
                        <%
                            ...
                            for (int i = 1; i <= dem; i++) {%>
                        <li><a href="ServletXulycongvan?pages=<%= i%>"><%= i%></a></li>
