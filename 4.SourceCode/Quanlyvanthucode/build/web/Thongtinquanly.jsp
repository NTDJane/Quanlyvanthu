    ...
    <div class="fullcontent">
        <div class="bottom-content">
            ...
            <div class="right730">
                <form >
                    <div class="search">
                        <h4 style="color: #fff; margin-left: 20px;height: 2%;text-align: center">Your information </h4>
                        <br>

                        <div style="background: #fff;color: #000;font-size: 12px" class="container-fluid" style="display: inline-block">
                            <label class="col-lg-3">Name</label>
                            <input class="" type="text" name="name" style="margin-left: 5%;margin-top:10px "><br>
                            <label class="col-lg-3">Address</label>
                            <input type="text" name="address"  style="margin-left: 5%" >
                            <br>

                            <label class="col-lg-3">Date of births</label>
                            <input type="date" name="dateofbirth"  style="margin-left: 5%" >
                            <br>


                            <label class="col-lg-3">Email</label>
                            <input type="text" name="email"  style="margin-left: 5%" >
                            <br>

                            <label class="col-lg-3">Phone number</label>
                            <input name="phonenumber" option="" style="margin-left: 5%"> <br>

                            <label class="col-lg-3">Gender</label>
                            <input type="checkbox" value="1" name="female"  style="width:5%;margin-top: 10px" checked/>Female &nbsp; 
                            <input type="checkbox" value="0" name="male"  style="width:5%;margin-top: 10px"/>Male
                            <br>
