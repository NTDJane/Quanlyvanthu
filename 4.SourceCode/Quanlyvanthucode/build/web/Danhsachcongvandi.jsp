...
<%
    ArrayList<Congvandi> danhsachcongvan = (ArrayList) request.getAttribute("Danhsachtatcacongvan");
...
<div class="container" >
    <div class="fullcontent">
        <div class="bottom-content">
            ...
            <div ></div>
            <div class="right730">
                <h3 style="font-size: 30px;font-style: inherit;text-align: center">List Dispatch To </h3>
                ...
                <table >
                    ...
                    <tbody>
                        <%
                            String trichdan = "";
                           // String trangthai="";
                            for (Congvandi congvan : danhsachcongvan) {
                        ...
                        <tr style="height: 70px">
                            <td style="width: 75px;text-align: left">
                                <a href="Khungthongtincua1congvandi?idcongvan=<%=congvan.getIdcongvan()%>&sohieu=<%= congvan.getSohieuvanbandi()%>">  <%= congvan.getSohieuvanbandi()%></a>
                            </td>
                                <td style="height: 70px"> <%=trichdan%></td>
                            <td style="width: 100px;text-align: center"><%=congvan.getNgayphathanh()%></td>
                            <td><%=congvan.getNoinhan()%></td>
                        </tr>
                        <%}%>
                    </tbody>
                </table>
                <div>
                    ...
                    <ul class="pagination">
                        <%
                            ...
                            for (int i = 1; i <= dem; i++) {%>
                        <li><a href="Danhsachcongvandi?pages=<%= i%>"><%= i%></a></li>
