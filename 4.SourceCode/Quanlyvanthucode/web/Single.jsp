...
<%
Congvanden congvan=(Congvanden)request.getAttribute("Thongtincua1congvan");
%>
    ...
    <div class="fullcontent">
        <div class="bottom-content">
            ...
            <div class="right730">
                ...
                <div>
                    <span>File download:<a href="<%=congvan.getDuongtai()%>"><%=congvan.getDuongtai().substring(5)%></a></span>
                ...
                <table >
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><%=congvan.getSohieu()%></td>
                            <td>Date issued</td>
                            <td><%=congvan. getNgaybanhanh()%></td>
                        </tr>
                        <tr>
                            <td>The signer</td>
