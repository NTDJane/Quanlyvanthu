    ...
    <div class="fullcontent">
        <div class="bottom-content">
            ...
            <div class="right730">
                ...
                <form action="Themvaocosodulieucoquanbanhanh" method="get" enctype="multipart/form-data" >
                    <label class="col-lg-3">Name Issued(*)</label>
                    <input type="text" name="nameissued"  style="margin-left: 5%"  >
                    <br>
                    <label class="col-lg-3">Adress(*)</label>
                    <input type="text" name="adress"  style="margin-left: 5%"   >
                    <br>
                    <label class="col-lg-3">Phone number</label>
                    <input type="text" name="phonenumber"  style="margin-left: 5%"   >
                    <br>
                    <button type="submit" class="col-sm-offset-4 btn btn-info" value="Submit" style="margin-top: 10px ;margin-bottom: 10px" >Submit</button>
