 ...
 * @author nguyendoan
 */
@WebServlet(name = "Danhsachcongvanden", urlPatterns = {"/Danhsachcongvanden"})
public class Danhsachcongvanden extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Danhsachcongvanden</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Danhsachcongvanden at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            danhsachcongvan = congvanquerry.Laytatcadanhsachcongvan();
            ...
            congvanquerry.Kiemtracongvanhethan(congvan.getSothutu(),String.valueOf(LocalDate.now()) );
            }
            
            danhsachcongvan = congvanquerry.Danhsachcongvanduocdoctheonguoixulyvaphanquyen(begin, limit, nguoidung.getIdcanhan(), nguoidung.getQuyenhanh());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            danhsachcongvan = congvanquerry.Laytatcadanhsachcongvanphantrang(begin, limit);
            danhsachcoquan = coquanquerry.Laydanhsachcoquanbanhanh();
            ArrayList<Tinhtrangxuly> danhsachtrangthai = congvanquerry.Laytrangthaicongvan();
            request.setAttribute("Danhsachcoquan", danhsachcoquan);
