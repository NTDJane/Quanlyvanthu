 ...
 * @author nguyendoan
 */
@WebServlet(name = "ServletXulycongvan", urlPatterns = {"/ServletXulycongvan"})
public class ServletXulycongvan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletXulycongvan</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletXulycongvan at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            danhsachcongvan = congvanquerry.Laydanhsachcongvanchonguoixuly(nguoidung.getIdcanhan(), begin, limit);
