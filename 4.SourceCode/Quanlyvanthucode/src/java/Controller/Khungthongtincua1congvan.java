 ...
 * @author nguyendoan
 */
@WebServlet(name = "Khungthongtincua1congvan", urlPatterns = {"/Khungthongtincua1congvan"})
public class Khungthongtincua1congvan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Khungthongtincua1congvan</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Khungthongtincua1congvan at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       // System.out.println(idcongvan+sohieu);
        try {
            Congvanden congvan=congvanquerry.Laycongvantheoidvasohieu(idcongvan,sohieu);
